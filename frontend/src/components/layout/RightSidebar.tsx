      ...
      <Tabs defaultValue="ask" className="flex flex-col h-full">
        ...
        <div className="flex-1 overflow-y-auto p-4">
          <TabsContent value="ask" className="mt-0 focus-visible:outline-none">
            ...
            <p className="text-xs text-muted-foreground/70 leading-relaxed">AI chat placeholder. Ask questions about your characters or plot.</p>
          </TabsContent>
          <TabsContent value="rewrite" className="mt-0 focus-visible:outline-none">
            <h3 className="text-[10px] font-semibold mb-3 text-muted-foreground/50 uppercase tracking-widest">AI Rewrite</h3>
            <p className="text-xs text-muted-foreground/70 leading-relaxed">Select text in the editor to see rewrite suggestions.</p>
          </TabsContent>
          <TabsContent value="notes" className="mt-0 focus-visible:outline-none">
            <h3 className="text-[10px] font-semibold mb-3 text-muted-foreground/50 uppercase tracking-widest">Notes</h3>
            <p className="text-xs text-muted-foreground/70 leading-relaxed">Quick notes and ideas.</p>
          </TabsContent>
          <TabsContent value="citations" className="mt-0 focus-visible:outline-none">
            ...
            <p className="text-xs text-muted-foreground/70 leading-relaxed">References to wiki pages found in current context.</p>
          </TabsContent>
        </div>
      </Tabs>
    </aside>
